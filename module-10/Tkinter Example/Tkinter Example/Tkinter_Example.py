...
class Todo(tk.Tk):
    def __init__(self, tasks=None) :
        ...
        todo1 = tk.Label(self.tasks_frame, text="--- Add Items Here --- **Right Click Item to Delete**", bg="#ffee55", #Xanthe color
        fg="black", pady=10)
        ...
        self.colour_schemes = [{"bg": "#ffee55", "fg": "black"}, {"bg": "#DF00FF", "fg": "white"}] # Colors: Xanthe, Phlox
